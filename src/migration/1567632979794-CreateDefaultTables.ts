...
export class CreateDefaultTables1567632979794 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<any> {
    ...
    await queryRunner.query(`CREATE TABLE "mbti_test" ("id" SERIAL NOT NULL, "step" integer NOT NULL, "completed" boolean NOT NULL, "result" character varying, "e" integer, "i" integer, "n" integer, "s" integer, "t" integer, "f" integer, "j" integer, "p" integer, "completedAt" TIMESTAMP, "userId" integer, CONSTRAINT "PK_653d1fa12a7fcf8e5fcd520c666" PRIMARY KEY ("id"))`);
    ...
    await queryRunner.query(`CREATE TABLE "mbti_question" ("id" SERIAL NOT NULL, "number" integer NOT NULL, "key" character varying NOT NULL, "value" character varying NOT NULL, CONSTRAINT "PK_eef0caef161e2b4d816713400cf" PRIMARY KEY ("id"))`);
    await queryRunner.query(`ALTER TABLE "mbti_answer" ADD CONSTRAINT "FK_361741af16784a144cf0246426d" FOREIGN KEY ("testId") REFERENCES "mbti_test"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
